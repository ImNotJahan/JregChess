...
public class Centaur extends Pawn {
    public Centaur(Color color) {
        super(color);
    }
    ...
    @Override
    public Icon getIcon() {
        if(getColor() == Color.White) return Icons.icons.get("white/centaur.png");
        return Icons.icons.get("black/centaur.png");
    }
}
