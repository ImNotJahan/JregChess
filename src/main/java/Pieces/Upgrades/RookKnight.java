...
public class RookKnight extends Rook {
    public RookKnight(Color color) {
        super(color);
    }
    ...
    @Override
    public Icon getIcon() {
        if(getColor() == Color.White) return Icons.icons.get("white/rook-knight.png");
        return Icons.icons.get("black/rook-knight.png");
    }
}
